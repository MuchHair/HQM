...
from engine import evaluate, train_one_epoch, train_one_epoch_gt, evaluate_hoi
    ...
    if args.eval:
        if args.hoi:
            ...
            evaluate_hoi(args.dataset_file, model, postprocessors, data_loader_val,
                         args.subject_category_id, device, args.output_dir, epoch, args.eval_gt)
            return
        else:
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.hoi:
            if 'hico' in args.dataset_file:
                start_save = 0.265
            elif 'vcoco' in args.dataset_file:
                start_save = 0.5
            elif 'hoia' in args.dataset_file:
                start_save = 0.70
            # todo
            if epoch > 40 or epoch % 5 == 0:
...
if __name__ == '__main__':
    ...
    if args.output_dir:
        ...
        with (output_dir / f"{aa}setting.txt").open("a") as f:
