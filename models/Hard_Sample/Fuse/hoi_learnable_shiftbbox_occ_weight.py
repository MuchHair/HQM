...
class DETRHOI(nn.Module):
    ...
    def forward(self, samples: NestedTensor, gt_items=None, target=None, epoch=0):
        ...
        if self.aux_loss and gt_items is not None:
            ...
            att, att_gt,  att_occ, hs, hs_gt, hs_occ = self.transformer(self.input_proj(src), mask, self.query_embed.weight,
                                                      ...
                                                      pos_embed=pos[-1], occ_embed_q=occ_embed_q, occ_embed_e=occ_embed_e)
            ...
            out['aux_outputs'] = self._set_aux_loss(outputs_obj_class, outputs_verb_class,
                                                    ...
                                                    hs, hs_gt, hs_occ, att, att_gt, att_occ)
        else:
            outputs_sub_coord, outputs_obj_coord, outputs_obj_class, outputs_verb_class, \
    ...
    def _set_aux_loss(self, outputs_obj_class, outputs_verb_class, outputs_sub_coord, outputs_obj_coord,
        ...
        ans2 = [{'pred_obj_logits': a, 'pred_verb_logits': b, 'pred_sub_boxes': c, 'pred_obj_boxes': d,
                 ...
                 'hs': h1, 'hs_gt': h2,  'hs_occ': h3,  'att': att1, 'att_gt': att2, 'att_occ': att3}
...
def build(args):
    ...
    weight_dict['loss_occ_obj_ce'] = args.obj_loss_coef * 0.5
    weight_dict['loss_occ_verb_ce'] = args.verb_loss_coef * 0.5
    weight_dict['loss_occ_sub_bbox'] = args.bbox_loss_coef * 0.5
    weight_dict['loss_occ_obj_bbox'] = args.bbox_loss_coef * 0.5
    weight_dict['loss_occ_sub_giou'] = args.giou_loss_coef * 0.5
    weight_dict['loss_occ_obj_giou'] = args.giou_loss_coef * 0.5

    weight_dict['loss_gt_obj_ce'] = args.obj_loss_coef * 0.5
    weight_dict['loss_gt_verb_ce'] = args.verb_loss_coef * 0.5
    weight_dict['loss_gt_sub_bbox'] = args.bbox_loss_coef * 0.5
    weight_dict['loss_gt_obj_bbox'] = args.bbox_loss_coef * 0.5
    weight_dict['loss_gt_sub_giou'] = args.giou_loss_coef * 0.5
    weight_dict['loss_gt_obj_giou'] = args.giou_loss_coef * 0.5
