...
from models.transformer import build_hoi_transformer_learnable_shiftbbox_occ_pass
    ...
    def forward(self, samples: NestedTensor, gt_items=None, target=None, epoch=0, occ_pass=False):
        ...
        if  gt_items is not None:
            ...
            att, att_gt, hs, hs_gt = self.transformer(self.input_proj(src), mask, self.query_embed.weight,
                                                      ...
                                                      pos_embed=pos[-1], occ_pass=occ_pass)
...
def build(args):
    ...
    transformer = build_hoi_transformer_learnable_shiftbbox_occ_pass(args, begin_l=begin_l,
