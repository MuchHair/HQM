...
from models.transformer import build_hoi_transformer_learnable_shiftbbox_occ_check_occ
...
class DETRHOI(nn.Module):
    ...
    def forward(self, samples: NestedTensor, gt_items=None, target=None, epoch=0):
        ...
        if self.aux_loss and gt_items is not None:
            ...
            t_sp = gt_sp_vec # torch.tanh(self.query_embed_sp(gt_sp_vec))
...
def build(args):
    ...
    transformer = build_hoi_transformer_learnable_shiftbbox_occ_check_occ(args, begin_l=begin_l,
    ...
    losses = ['obj_labels', 'verb_labels', 'sub_obj_boxes', 'obj_cardinality',
              'occ_obj_labels', 'occ_verb_labels', 'occ_sub_obj_boxes']
