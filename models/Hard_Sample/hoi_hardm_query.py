...
from models.transformer import build_hoi_transformer_ts_qpos_eobj_attention_map_hardm
...
def build(args):
    ...
    transformer = build_hoi_transformer_ts_qpos_eobj_attention_map_hardm(args, begin_l=begin_l,
