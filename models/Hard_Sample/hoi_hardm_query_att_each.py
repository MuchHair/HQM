...
from models.transformer import build_hoi_transformer_ts_qpos_eobj_attention_map_hardm_attn_each
...
class DETRHOI(nn.Module):
    ...
    def forward(self, samples: NestedTensor, gt_items=None, target=None, epoch=0):
        ...
        if self.aux_loss:
            ...
            att, att_hq, hs, hs_hq = self.transformer(self.input_proj(src), mask, self.query_embed.weight,
...
def build(args):
    ...
    transformer = build_hoi_transformer_ts_qpos_eobj_attention_map_hardm_attn_each(args, begin_l=begin_l,
    ...
    losses = ['obj_labels', 'verb_labels', 'sub_obj_boxes', 'obj_cardinality',
              'hq_obj_labels', 'hq_verb_labels', 'hq_sub_obj_boxes']
